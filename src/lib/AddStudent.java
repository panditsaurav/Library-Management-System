...
public class AddStudent extends JFrame implements ActionListener{
	...
	comboBox.setModel(new DefaultComboBoxModel(new String[] { "Electronics", "Computer Science", "IT","Telecommunication ","Other" }));
	...
	comboBox_3.setModel(new DefaultComboBoxModel(
			new String[] { "B.E", "B.Tech", "M.Tech", "B.Sc", "M.Sc" }));
	...
	panel.setBorder(new TitledBorder(new LineBorder(new Color(100, 50, 130), 3, true), "Add Student",
			TitledBorder.CENTER, TitledBorder.TOP, null, new Color(30, 144, 255)));
    ...
    public void actionPerformed(ActionEvent ae){
        try{
            ...
            if(ae.getSource() == b1){
                try{
                conn con = new conn();
                String sql = "insert into proj.student(student_id, name, father, course, branch, year, semester) values(?, ?, ?, ?, ?, ?, ?)";
