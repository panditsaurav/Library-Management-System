...
public class Issuebook extends JFrame implements ActionListener{
	...
	panel_1.setBorder(new TitledBorder(new LineBorder(new Color(170, 230, 200), 2, true), "Students Deatails",
			TitledBorder.CENTER, TitledBorder.TOP, null, new Color(100, 149, 237)));
    ...
    public void actionPerformed(ActionEvent ae){
		...
		rs.close();
            ...
            if(ae.getSource() == b2){
                String sql = "select * from proj.student where student_id = ?";
		PreparedStatement st = con.c.prepareStatement(sql);
		...
		rs.close();
            ...
            if(ae.getSource() == b3){
                    try{
                String sql = "insert into issuebook(book_id, student_id, bname, name, course, branch, doi) values(?, ?, ?, ?, ?, ?, ?)";
		PreparedStatement st = con.c.prepareStatement(sql);
		st.setString(1, t1.getText());
