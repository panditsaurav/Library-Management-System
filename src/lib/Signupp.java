...
public class Signupp extends JFrame implements ActionListener{
    ...
    public Signupp(){
        setTitle("NEW LIBRARY ACCOUNT APPLICATION FORM");      
        ...
        l2 = new JLabel("Please Fill all Details");
	...
	panel.setBorder(new TitledBorder(new LineBorder(new Color(150, 70, 150), 3), "Library account form", TitledBorder.CENTER,
			TitledBorder.TOP, null, new Color(0, 0, 255)));
	panel.setBounds(20, 35, 800, 600);
        add(panel);
        setSize(850,800);
        setLocation(500,120);
        setVisible(true);
       ...
       conn con = new conn();
        ...
        try{
           
            {
                ...
                String sql = "insert into signup(name,last_name,dob,gender,email,address,city,pincode,state) values(?,?,?,?,?,?,?,?,?)";
