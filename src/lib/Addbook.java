...
public class Addbook extends JFrame implements ActionListener{
	...
	panel.setBorder(new TitledBorder(new LineBorder(new Color(100, 50, 130), 3), "Add Books", TitledBorder.CENTER,
    ...
    public void actionPerformed(ActionEvent ae){
        try{
            conn con = new conn();
            if(ae.getSource() == b1){
                String sql = " insert into proj.book(book_id, bname, isbn, publisher, edition, price) values(?, ?, ?, ?, ?,?)";
